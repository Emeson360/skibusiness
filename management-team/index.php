                                ...
                                <div class="site-branding">
                                    <a class="logo-dark" href="../index.php" title="Zeenab Foods" rel="home"><img src="../wp-content/uploads/2022/03/Logoze.png" alt="Zeenab Foods"/></a><a class="logo-light" href="../index.php" title="Zeenab Foods" rel="home"><img src="../wp-content/uploads/2022/03/Logoze.png" alt="Zeenab Foods"/></a><a class="logo-mobile" href="../index.php" title="Zeenab Foods" rel="home"><img src="../wp-content/uploads/2022/03/zeenab-favicon.png" alt="Zeenab Foods"/></a>                                </div>
                                                ...
                                                <div class="ct-item-text">
                                                    ...
                                                    <a href="mailto:info@zeenabfoods.com">info@zeenabfoods.com</a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="ct-item-text">
                                                    <p>Make a call</p>
                                                    <a href="tel:08093467008">0809 3467 008</a>
                                                </div>
                                            </div>
...
<footer id="colophon" class="site-footer font-smooth footer-layout1 footer-4-column">
            ...
            <div class="container">
                <div class="row">
                    <div class="cms-footer-item col-xl-3 col-lg-3 col-md-6 col-sm-12"><section id="custom_html-8" class="widget_text widget widget_custom_html"><div class="textwidget custom-html-widget"><p style="font-size:15px;">ZEENAB Foods Limited  was established to produce, process and package various Agro commodities (grains, pulses and edible oil) in pursuance to provide quality products and services for onward distribution to our local and international consumers..</p></div></section><section id="cs_social_widget-1" class="widget widget_cs_social_widget"><ul class='cms-social-media'><li><a class="social-facebook" target="_blank" href="#"><i class="zmdi zmdi-facebook"></i></a></li><li><a class="social-twitter" target="_blank" href="#"><i class="zmdi zmdi-twitter"></i></a></li><li><a class="social-google" target="_blank" href="#"><i class="zmdi zmdi-google-plus"></i></a></li><li><a class="social-instagram" target="_blank" href="#"><i class="zmdi zmdi-instagram"></i></a></li></ul></section></div><div class="cms-footer-item col-xl-3 col-lg-3 col-md-6 col-sm-12">        <div class="cms-get-in-touch widget">
                            <h3 class="widget-title footer-widget-title">Contact Us</h3>
                                        <div class="cms-contact-info-item type-phone">
                    <div class="cms-contact-info-holder">
                        <span>Phone:</span>                        <a href="tel:2348093467008">+ 234 809 346 7008</a>
                    </div>
                </div>
                                        <div class="cms-contact-info-item type-email">
                    <div class="cms-contact-info-holder">
                        <span>Email:</span>                        <a href="mailto:info@zeenabfoods.com">
                            info@zeenabfoods.com                        </a>
                    </div>
                </div>
                                        <div class="cms-contact-info-item type-address">
                    <div class="cms-contact-info-holder">
                        <span>Address:</span>                        <a href="http://maps.google.com/?q=Plot%20252,%20Cadastral%20Zone%20C16,%20Idu%20Industrial%20Area%201,%20Idu,%20Abuja." target="_blank">
                            Plot 252, Cadastral Zone C16, Idu Industrial Area 1, Idu, Abuja.                        </a>
                    </div>
                </div>
                                </div>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4163"><a href="../vegetable-oil/index.php">Edible Oils</a></li>
                            ...
                            <h3 class="widget-title footer-widget-title">Our Locations </h3>
                                                                <div class="cms-contact-info-item type-address">
                    <div class="cms-contact-info-holder">
                        <span>Kano:</span>                        <a href="http://maps.google.com/?q=Km%2010%20Katsina%20road%20beside%20UIG%20filling%20station,%20Dawanau%20market,%20Kano,%20Nigeria." target="_blank">
                            Km 10 Katsina road beside UIG filling station, Dawanau market, Kano, Nigeria.                        </a>
                    </div>
                </div>
                                </div>
        </div>                </div>
                ...
                <div class="col-12">
                    <div class="bottom-col">
                        <div class="bottom-copyright">
                            Copyright © Zeenab Foods Limited. All rights reserved                        </div>
