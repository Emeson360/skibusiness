...
<body>
    <div class="page" style="background-color: #D3D3D3;">
                        ...
                        <div class="contact-box">
                            <div class="nav-numbar">
                                <a href="tel: +234 7062993384">
                                    <svg xmlns="#" id="Layer_1" x="0" y="0" version="1.1" viewBox="0 0 29 29" xml:space="preserve" fill="#F26821" width="28" height="22">
                            ...
                            <div class="nav-numbar">
                                <a href="mailto:info@EEH.com">
                                    <svg xmlns="#" viewBox="0 0 128 96" fill="#F26821" width="18" height="28">
                            ...
                            <div class="container">
                                <div class="manu-list">
                                    <ul class="listing-box">
                                        ...
                                        <li class="about-main">
                                            <a href="#">About</a>
                                            <svg xmlns="#" viewBox="0 0 24 24" width="28" fill="#fff">
        ...
        <div class="container bg-gradient " >
            <div class="vh-100 d-flex align-items-center justify-content-center ">
                <div class="col-md-6 p-4 card border border-primary" style="margin-top: 200px;">
                    <div class="message">
                    </div>
                    <div class="loginHeader pt-3 pb-4">
                        <h4 class="text-center">Password recovery</h4>
                        <p class="text-center">We'll send you instructions in email.</p>
                    </div>
                    <form action="" method="POST" id="user_forgot_password">
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" placeholder="email">
                        </div>
                        <div class="form-group">
                            <button type="submit" id='Password_recovery_btn' class="btn btn-block btn-lg btn-primary">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            $(document).ready(function() {
                ...
                $("#user_forgot_password").validate({
                    ...
                    submitHandler: function(form) {
                        $("#loader").show();
                        $("#Password_recovery_btn").addClass("disabled");
                        var email = $(form).find('[name="email"]').val();
                        $.ajax({
                            url: "<?php ROOT_URL ?>forgot-password.php",
                            method: 'post',
                            data: {
                                email: email
                            },
        ...
        <div class="container">
            <div class="footer-sub-sec">
                ...
                <div class="footer-terms">
                    <p class="second"><a href="terms.php">Terms</a> | <a href="privacy.php">Privacy</a> Powered by - <a href="#" target="_blank">Skibusiness</a>
                    </p>
                </div>
            </div>
        </div>
...
<!-- Mirrored from www.nigerianexportershub.com/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Feb 2023 02:50:56 GMT -->
