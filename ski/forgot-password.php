	...
	<div class="container header-main-box">
...
</header>            <div class="container bg-gradient">
        <div class="vh-100 d-flex align-items-center justify-content-center">
            <div class="col-md-6 p-4 card">
                ...
                <form action="https://www.nigerianexportershub.com/forgot-password" method="POST" id="user_forgot_password">
        ...
        $(document).ready(function() {
            ...
            $("#user_forgot_password").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "https://www.nigerianexportershub.com/forgot-password",
                        method: 'post',
                        data: {
                            email: email
                        },
