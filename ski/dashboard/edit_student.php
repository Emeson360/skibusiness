...
$uid = $_GET['uid'];
 require_once('../db.php');
 $sel = $db->query("SELECT * FROM students WHERE school_name ='$sch_name' AND uid='$uid'");
 $s_ = $sel->fetch_assoc();
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/light/add_staff.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Aug 2022 04:54:50 GMT -->
<head>
	<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="php/edit_student.php" method="POST" enctype="">
								<div class="card-body row">
								<div class="col-lg-6 p-t-20">
								<input class="mdl-textfield__input" type="hidden" id="txtFirstName" name="uid" value="<?php echo $s_['uid'];  ?>">
										
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" readonly type="text" id="txtFirstName" name="sch_name" value="<?php echo $s_['school_name'];  ?>">
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" readonly id="txtFirstName" name="regno" value="<?php echo $s_['student_id'];  ?>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="fname" value="<?php echo $s_['s_name'];  ?>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"  name="join" value="<?php echo $s_['s_addmission_date'];  ?>">
											<label class="mdl-textfield__label">Admission Date</label>
										</div>
									</div>
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											...
											<select name="gender" class="mdl-textfield__input" >
                                                <option value="<?php echo $s_['s_gender'];  ?>">Current: <?php echo $s_['s_gender'];  ?></option>
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											...
											<label for="sample2" class="mdl-textfield__label">Class</label>
											<select name="class" class="mdl-textfield__input" >
                                                <option value="<?php echo $s_['s_class'];  ?>">Current class is <?php echo $s_['s_class'];  ?></option>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"  name="dob" value="<?php echo $s_['s_dob'];  ?>">
									...
									<div class="col-lg-12 p-t-20 text-center">
										<input  type="submit" name="editstudent"
