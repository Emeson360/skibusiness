...
<body
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Pin Students</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Pin Students</li>
							</ol>
						</div>
					</div>
					<div class="row">
									...
									<div class="tab-pane active fontawesome-demo" id="tab1">
								      ...
								      <!--                              </tr>-->
													...
													<div class="card-body ">
														...
														</div> table-hover table-checkable order-column valign-middle-->
	...
	<div class="table-responsive">
														<table
															...
															<tbody>
													<?php require_once("inc-view2-pin.php"); ?>			
																
														</tbody>
														</table>
														</div>
													<input type="submit" name="submit" class="btn btn-success" onclick="window.print();" value="Export pdf">
