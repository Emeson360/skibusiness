									...
									<div class="card-body no-padding height-9">
										<div class="row">
											<div class="profile-userpic">
												<img src="assets/img/user/user4.jpg" class="img-responsive" alt="">
											</div>
										</div>
										<div class="profile-usertitle">
											<div class="profile-usertitle-name"> <?php  echo $t_['fname'].' ' . $t_['lname'];  ?> </div>
											<div class="profile-usertitle-job"> <?php  echo $t_['designation'];  ?></div>
										</div>
								...
								<div class="card">
									...
									<div class="card-body no-padding height-9">
										...
										<ul class="list-group list-group-unbordered">
											<li class="list-group-item">
												<b>Gender </b>
												<div class="profile-desc-item pull-right"><?php echo $t_['gender'];  ?></div>
											</li>
											<li class="list-group-item">
												<b>Operation Done </b>
											...
											<li class="list-group-item">
												<b>Degree </b>
												<div class="profile-desc-item pull-right"><?php echo $t_['education'];  ?></div>
											</li>
											<li class="list-group-item">
												<b>Designation</b>
												<div class="profile-desc-item pull-right"><?php echo $t_['designation'];  ?></div>
											</li>
										</ul>
													...
													<div id="biography">
														<div class="row">
															<div class="col-md-3 col-6 b-r"> <strong>Full Name</strong>
																<br>
																<p class="text-muted"><?php echo $t_['fname'].' '. $t_['lname'];  ?> </p>
															</div>
															<div class="col-md-3 col-6 b-r"> <strong>Mobile</strong>
																<br>
																<p class="text-muted"><?php echo $t_['phone'];  ?></p>
															</div>
															<div class="col-md-3 col-6 b-r"> <strong>Email</strong>
																<br>
																<p class="text-muted"><?php echo 'example@gmail.com';  ?></p>
															</div>
															<div class="col-md-3 col-6"> <strong>Location</strong>
																<br>
																<p class="text-muted"><?php echo $t_['address'];  ?></p>
															</div>
														</div>
														<hr>
