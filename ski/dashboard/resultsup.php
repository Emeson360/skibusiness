					...
					<ul class="nav navbar-nav pull-right">
						...
						<!-- start language menu -->
							...
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile"> <?php   //echo $position; ?>
							</a>
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					<div class="page-bar">
						...
						<div class=" pull-left">
								<div class="page-title">Upload Result</div>
							</div>
...
<div class="col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="card  card-box">
													<div class="card-head">
														...
														<button id="chatlist" class="mdl-button mdl-js-button mdl-button--icon pull-right" data-upgraded=",MaterialButton">
															<!--<i class="material-icons">more_vert</i>-->
														</button>
													</div>
																...
																<form action="" method="post">
																	<div class="input-group">
																		<select class="form-control" name="school">
																			...
																			require_once('../db.php');
																			$sel = $db->query("SELECT DISTINCT school_name FROM student_results ");//student_results
																			if ($sel->num_rows < 1) {
																		...
																		<span class="input-group-btn">
																			<button type="submit" name="vresult" class="btn btn-warning btn-flat"><i class="fa fa-arrow-right"></i></button>
																		</span>
																	</div>
...
<!-- /////////////////////////////////////////////// -->
	<div class="col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="card  card-box">
													<div class="card-head">
														<header>Upload Result By Inputting</header>
														<button id="chatlist" class="mdl-button mdl-js-button mdl-button--icon pull-right" data-upgraded=",MaterialButton">
															<!--<i class="material-icons">more_vert</i>-->
														</button>
																...
																<form action="" method="post" >
																	<div class="input-group">
																		<select class="form-control" name="school">
																			...
																			require_once('../db.php');
																			$sel = $db->query("SELECT * FROM schools WHERE school_name='$sch_name'");
																			if ($sel->num_rows < 1) {
																		...
																		<span class="input-group-btn">
																			<button type="submit" name="result" class="btn btn-warning btn-flat"><i class="fa fa-arrow-right"></i></button>
																		</span>
																	</div>
											...
											<div class="col-md-12">
												<div class="card card-box">
													...
													<div class="card-body ">
														...
														{ //require('inc_result.php'); 
														
														    require_once("inc-result-real.php");
														}
														
														if(isset($_GET['uid']))
														{
															require('inc_edit_result.php');
														}
														if(isset($_GET['uid_del']))
														{
															require('php/viewR.php');
														}
														if(isset($_POST['upresult']))
														{
															require_once('php/update_result.php');
														}
														if(isset($_POST['upload']))
														{
														require_once('php/insert_result.php');	
														}
														if(isset($_POST['vresult']))
														{
														require_once('php/viewR.php');	
														}
