...
<head>
	...
	<title>Catholic Education Services, Catholic Diocese of Enugu, Enugu State, Nigeria</title>
	<!-- google font -->
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<ul data-mdl-for="list2" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item" data-val="Primary 1">Primary1</li>
												<li class="mdl-menu__item" data-val="Primary 2">Primar 2</li>
												<li class="mdl-menu__item" data-val="Primary 3">Primar 3</li>
												<li class="mdl-menu__item" data-val="Primary 4">Primar 4</li>
												<li class="mdl-menu__item" data-val="Primary 5">Primar 5</li>
												<li class="mdl-menu__item" data-val="Primary 6">Primar 6</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											...
											<label class="mdl-textfield__label" for="text7">Enter Admission PIN</label>
										</div>
									</div>
									<!--<div class="col-lg-12 p-t-20">
