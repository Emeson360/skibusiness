				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Result Section</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
																	<p>Filter By Class</p>					
<form action="" method="POST">    
<select name="class" id="class" onchange="filter(this.value)" style="width:160px;" class='form-control'> 
							...
							<div class="tabbable-line">
								...
								<div class="tab-content">
									<div class="tab-pane active fontawesome-demo" id="tab1">
										...
										<!--<div class="col-md-6">-->
										<!--			<form action="" method="POST">-->
										<!--				    <input type="file" name="result" class="form-control" required style="width:290px;">-->
										<!--				<button  type="button" id="rowAdder" class="btn btn-dark">-->
								  ...
								  <!--                          </div>-->
											...
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
															<div class="col-md-6">
															    <?php //require_once("inc-download-result-temp.php");  ?>
													
								                            </div>
	<div class="col-md-6">
															    
														<input type="text" class="form-control" name="myInput" id="myInput" placeholder="Search Result">
								                            </div>
                                                    ...
                                                    <!-- This is for results -->
                                                    <!-- <div class="card-body" id="res_filter"></div> -->
													<!--<div class="card-body" id="res">-->
														
															<?php  //require('inc-uploadresult.php'); ?>

													
													<!-- <input type="submit" name="submit" class="btn btn-success" value="Export pdf"> -->
...
<!--</div>-->
						    <hr>
	<div class="myTablefile" id="resfile"></div>
...
//   });
  ...
  $("#myInput").on("keyup", function() {
    ...
    $(".myTablefile tr").filter(function() {
