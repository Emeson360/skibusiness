					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="php/insert_teacher.php" method="POST" enctype="">
								<div class="card-body row">

							<!--	<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="uname">
								...
								<!--	<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="password" id="txtLasttName" name="upass">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="date" id="date" name="join">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="list2" name="department" 
												>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" rows="4" id="education" name="education"></textarea>
