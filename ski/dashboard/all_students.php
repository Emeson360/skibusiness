...
<head><script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.3/html2pdf.bundle.min.js" ></script>
	<meta charset="utf-8" />
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													...
													<!--<select name="class" id="class" class="form-control" onchange="fstudent(this.value); fstudent_2(this.value);"> -->
...
<button type="button" class="btn btn-primary" onclick="window.print()">
  Print
													...
													<section 	id="container_content">														<table
...
<tbody class="myTable" id="res">
													...
													<!--<input type="submit" name="submit" class="btn btn-success btn_print"  value="Export pdf">-->
  ...
  <div class="modal-dialog modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">	<input type="text" class="form-control" name="myInput" id="myInput1" placeholder="Search.."></h5>
...
<tbody class="myTable1" id="res1">
      ...
      <div class="modal-footer">
        ...
        <!--<button type="button" class="btn btn-primary btn_print" onclick="window.print()">Save PDF</button>-->
      </div>
    </div>
  </div>
</div>
...
//   {
//       //alert(value);
//      $.post("php/inc-all-students_filter_2.php",
//   {
//     class: value
//   },
//   function(data, status){
